                    ...
                    <div className="p-4">
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <div className="flex justify-between pt-2">
                                ...
                                >
                                    {isAddingToWishlist ? (
                                        <svg className="h-4 w-4 mr-1 animate-spin text-red-500" fill="none" viewBox="0 0 24 24">
                                            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                                            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z" />
                                        </svg>
                                    ) : (
                                        <svg xmlns="http://www.w3.org/2000/svg" className="mr-1 h-4 w-4 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
