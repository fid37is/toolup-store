...
const ProfilePage = () => {
    ...
    const [isSaving, setIsSaving] = useState(false); // Separate state for save button loading
    ...
    const handleSubmit = async () => {
        ...
        try {
            setIsSaving(true); // Only set save button loading, not page loading
            ...
            setIsSaving(false); // Reset save button loading
        }
    };

    // Show loading screen at the highest level if still loading
    if (isLoading) {
        return (
    ...
    // Main profile content - only rendered when user is loaded
    return (
        <>
            <Header />
            <main className="container max-w-6xl mx-auto px-4 py-8 bg-gray-50 min-h-screen">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex justify-end space-x-3">
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 bg-primary-500 text-white rounded hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 ${isSaving ? 'opacity-70 cursor-not-allowed' : ''}`}
                                            disabled={isSaving}
                                        >
                                            {isSaving ? (
